// 秋月電子通商のサンプルコードを参考　http://akizukidenshi.com/catalog/g/gK-12370/
#include <Arduino.h>
...
void loop()
{
  ...
  send_data = dtostrf((data - offset), 5, 3, s);
  num = send_data.toInt();
  if (num != 0 and num <2000) {
    Serial.write('H');
    Serial.write(highByte(num));
    Serial.write(lowByte(num));
  }
}
